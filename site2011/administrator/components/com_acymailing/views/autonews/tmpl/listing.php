...
<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>&amp;gtask=autonews" method="post" name="adminForm">
	<table>
		<tr>
			<td width="100%">
		...
		<tbody>
			...
			?>
				<tr class="<?php echo "row$k"; ?>">
					...
					<td align="center">
						<?php
						$text = '<b>'.JText::_('FROM_NAME',true).' : </b>'.$row->fromname;
						$text .= '<br/><b>'.JText::_('FROM_ADDRESS',true).' : </b>'.$row->fromemail;
						$text .= '<br/><br/><b>'.JText::_('REPLYTO_NAME',true).' : </b>'.$row->replyname;
						$text .= '<br/><b>'.JText::_('REPLYTO_ADDRESS',true).' : </b>'.$row->replyemail;
