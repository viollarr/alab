...
class statusquickType{
	function statusquickType(){
		$this->values = array();
		$this->values[] = JHTML::_('select.option', '0', JText::_('RESET') );
	...
	function display($map){
		return JHTML::_('select.radiolist', $this->values, $map , 'class="inputbox" size="1" onchange="updateStatus(this.value)"', 'value', 'text', '','status_all');
	}
}