			...
			****************************/
			...
			foreach($comunicacoes_coordenadas as $trabalho){
				...
				<div class="trabalho_avaliado">
				  ...
				  <div class="avaliar">
                  	<a href="avaliar_trabalho.php?id_tipo_trabalho=2&id_trabalho=<?=$trabalho["id"]?>"><img src="http://www.alab.org.br/eventosalab/images/edit_f2.png" title="Avaliar este trabalho" alt="Avaliar este trabalho" width="25" /></a>
                  </div>
				  <div style="clear:both"></div>
				</div>
	        	<?php
