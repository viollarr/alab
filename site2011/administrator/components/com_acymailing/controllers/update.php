...
<?php
	...
	function licensejs(){
		...
		?>
		<div id="acytext"></div>
		<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>&amp;gtask=update" method="post" name="adminForm" autocomplete="off">
		<input type="hidden" name="option" value="<?php echo ACYMAILING_COMPONENT; ?>" />
		<input type="hidden" name="task" value="addli" />
		<input type="hidden" name="gtask" value="update" />
	...
	function addli(){
		...
		if(empty($li) OR !$updateClass->saveL($li)){
			acymailing::display(JText::sprintf('ERROR_SAVING_LICENSE',$li),'error');
