...
ev_resumo(id_evento,id_linha_tematica,id_tipo_trabalho,id_comunicacao_coordenada,id_simposio,titulo,resumo,palavras_chave,autor,co_autor)
values('$id_evento','0','$id_trabalho','0','$id_simposio','$titulo','$resumo','$palavras','$id_autor','$id_coautor');";
						mysql_query($sql_insert, $conexao);
			...
			if(sizeof($error)==0){
				...
				for($i=0; $i<$qtde_trab; $i++){		
					if (!empty($array_trabalhos[$i])){
						...
						$sql_insert = "insert into ev_resumo(id_evento,id_linha_tematica,id_tipo_trabalho,id_comunicacao_coordenada,id_simposio,titulo,resumo,palavras_chave,autor,co_autor)
									   values('$id_evento','$linha_tematica','$id_trabalho','$id_ultima_coordenada_inserida','0','$titulo','$resumo','$palavras','$id_autor','$id_coautor');";
						mysql_query($sql_insert, $conexao);
						$registro_inserido=mysql_affected_rows();
		...
		if ($id_trabalho==3){
			...
			if(sizeof($error)==0){
				...
				$sql_insert = "insert into ev_resumo(id_evento,id_linha_tematica,id_tipo_trabalho,id_comunicacao_coordenada,id_simposio,titulo,resumo,palavras_chave,autor,co_autor)
					       values('$id_evento','$linha_tematica','$id_trabalho','0','0','$titulo','$resumo','$palavras','$id_participante','$id_coautor');";	
				mysql_query($sql_insert, $conexao);
				$registro_inserido=mysql_affected_rows();
