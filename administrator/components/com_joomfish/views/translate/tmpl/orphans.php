 ...
 * -----------------------------------------------------------------------------
 * $Id: orphans.php 1251 2009-01-06 18:33:02Z apostolov $
 * @package joomfish
 * @subpackage Views
 *
*/
...
$filterOptions .= '<td  nowrap align="center">' .JText::_('Content elements'). ':<br/>' .$this->clist. '</td>';
...
//$this->_JoomlaHeader( JText::_('CLEANUP ORPHANS'), 'orphan', $filterOptions );
	?>
