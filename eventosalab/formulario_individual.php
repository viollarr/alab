<table width="600" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><span class="txt_topico_tabela">
      <textarea name="resumo" cols="65" rows="15" class="formulario" id="resumo" onkeyup="counterUpdate('resumo', 'WordCount', 2000);"><?php if(sizeof($error)!= 0){ print stripslashes($resumo); } ?></textarea>
    </span></td>
  </tr>
  <tr>
    <td class="txt_topico_tabela">&nbsp;</td>
