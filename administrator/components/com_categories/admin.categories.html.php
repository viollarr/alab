			...
			<fieldset class="adminform">
				<legend><?php echo JText::_( 'Details' ); ?></legend>
					...
					window.onload = function() {
						...
						var tr_tipo_evento = document.getElementById('tr_tipo_evento');
						
						if (secao.value == 4)
							tr_tipo_evento.style.display = 'table-row';
							
						secao.onchange = function() {
							tr_tipo_evento.style.display = secao.value == 4 ? 'table-row' : 'none';	// secao.value == 4 => seção Eventos
						}
					}
					</script>
					<tr id="tr_tipo_evento" style="display: none;">
						<td class="key">
							<label for="tipo_evento">
								<?php echo JText::_('Tipo de evento'); ?>:
							</label>
						</td>
						<td colspan="2">
							<?php echo $lists['tipo_evento']; ?>
						</td>
					</tr>
					<tr>
						<td class="key">
