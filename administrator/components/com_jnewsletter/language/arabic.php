...
* @version $Id: arabic.php 001 2010-04-05 22:56:07Z divivo $
...
define('_ACA_NAME','الاسم');
define('_ACA_EMAIL','البريد الإلكتروني');
...
define('_ACA_SUB_INFO', 'معلومات المشترك');
define('_ACA_VERIFY_INFO', 'Please verify the link you submitted, some information are missing.');
define('_ACA_INPUT_NAME', 'الاسم');
define('_ACA_INPUT_EMAIL', 'البريد الإلكتروني');
define('_ACA_RECEIVE_HTML', 'استقبال الرسائل كHTML؟');
...
define('_ACA_ACCOUNT_CONFIRMED', 'تم تفعيل اشتراكك بنجاح');
...
define('_ACA_SUBSCRIPTIONS', 'اشتراكك');
...
define('_ACA_SUBSCRIBE_SUBJECT_MESS', 'فضلاً قم بتفعيل اشتراكك');
define('_ACA_UNSUBSCRIBE_SUBJECT_MESS', 'تأكيد إلغاء الاشتراك');
...
define('_ACA_COMFIRM_SUBSCRIPTION', 'تم إرسال رسالة تأكيد إلى بريدك الإلكتروني. فضلاً تأكد من بريدك الإلكتروني و اضغط على رابط التفعيل.<br />' .
		'يجب أن تقوم بتأكيد اشتراكك قبل أن تصل أي رسالة بريدية من القائمة.');
define('_ACA_SUCCESS_ADD_LIST', 'تمت إضافتك إلى القائمة بنجاح مسبقاً.');


 // Subcription info
define('_ACA_CONFIRM_LINK', 'رابط تفعيل الاشتراك. فضلاً اضغط هنا');
define('_ACA_UNSUBSCRIBE_LINK', 'رابط إلغاء الاشتراك من القائمة البريدية. فضلاً اضغط هناClick here to unsubscribe yourself from the list');
define('_ACA_UNSUBSCRIBE_MESS', 'تم إلغاء اشتراكك من القائمة البريدية');
...
define('_ACA_UNSUBSCRIBE_MESSAGE', 'هل أنت متأكد من إلغاء اشتراكك من القائمة البريدية؟');
define('_ACA_MOD_SUBSCRIBE', 'اشتراك');
define('_ACA_SUBSCRIBE', 'اشتراك');
define('_ACA_UNSUBSCRIBE', 'إلغاء الاشتراك');
define('_ACA_VIEW_ARCHIVE', 'View archive');
define('_ACA_SUBSCRIPTION_OR', ' أو اضغط هنا لتحديث معلومات اشتراكك');
define('_ACA_EMAIL_ALREADY_REGISTERED', 'البريد الإلكتروني مشترك مسبقاً.');
...
define('_ACA_CHANGE_SUBSCRIPTIONS', 'تغيير');
define('_ACA_CHANGE_EMAIL_SUBSCRIPTION', 'تغيير اشتراكك');
...
// mail settings
define('_ACA_SEND_MAIL_FROM', 'From Email<br/>(used as Bounced back for all your messages)');
...
define('_ACA_AUTO_OPTION_NONE', 'لا');
define('_ACA_AUTO_OPTION_NEW', 'New Users');
define('_ACA_AUTO_OPTION_ALL', 'All Users');

//
define('_ACA_UNSUB_MESSAGE', 'إلغاء اشتراك البردي الإلكتروني');
define('_ACA_UNSUB_SETTINGS', 'إعدادات إلغاء الاشتراك');
...
define('_ACA_INPUT_NAME_TIPS', 'اكتب اسمك كاملاً');
define('_ACA_INPUT_EMAIL_TIPS', 'اكتب بريدك الإلكتروني (تأكد من الأن العنوان صحيح لتستطيع استقبال رسائلنا).');
define('_ACA_RECEIVE_HTML_TIPS', 'اختر نعم إذا كنت تريد استقبال رسائل بصيغة HTML أو اختر لا لاستقبال الرسائل كنص.');
