  ...
  <div id="centro">
     ...
     <?php if ($modalidade_participacao==1) {//1 -> com trabalho //1 -> é associado alab?>
       ...
       <div id="box_trabalhos">
       	<span class="txt_topico_tabela">Para poder inscrever seu trabalho nas modalidades Comunica&ccedil;&atilde;o Coordenada e Comunica&ccedil;&atilde;o Individual &eacute; preciso ser Associado ALAB. Para os estrangeiros n&atilde;o &eacute; necess&aacute;ria esta associa&ccedil;&atilde;o.</span>
       <br />
       <ul><span class="txt_topico_tabela">Caso voc&ecirc;:</span>
        ...
        <li>n&atilde;o seja Associado ALAB, entre em   <a href="http://www.alab.org.br/" target="_blank">http://www.alab.org.br/</a> e clique na aba Associados para efetuar o seu cadastro.</li>
       </ul>
       <?php /*
			...
			foreach($trabalhos_cadastrados as $trabalho_cadastrado){
				...
				*/
				...
				switch($trabalho_cadastrado["id_tipo_trabalho"]){
					case 1:
						if($trabalho_cadastrado["eh_coordenador"]) echo "Coordenador do Simpósio <b>".$trabalho_cadastrado["titulo"]."</b>. Caso ainda não tenha cadastrado os trabalhos do simpósio será exibido um botão <b>Envie seu trabalho</b> abaixo.";
						elseif($trabalho_cadastrado["eh_autor"]) echo "Autor do trabalho <b>".$trabalho_cadastrado["titulo"]."</b> em um Simpósio.";
						elseif($trabalho_cadastrado["eh_co_autor"]) echo "Co-autor do trabalho <b>".$trabalho_cadastrado["titulo"]."</b> em um Simpósio.";
						break;
					
					case 2:
						if($trabalho_cadastrado["eh_coordenador"]) echo "Coordenador da Comunicação Coordenada <b>".$trabalho_cadastrado["titulo"]."</b>.";
						elseif($trabalho_cadastrado["eh_autor"]) echo "Autor do trabalho <b>".$trabalho_cadastrado["titulo"]."</b> em uma Comunicação Coordenada.";
						elseif($trabalho_cadastrado["eh_co_autor"]) echo "Co-autor do trabalho <b>".$trabalho_cadastrado["titulo"]."</b> em uma Comunicação Coordenada.";
						break;
					
					case 3:
						if($trabalho_cadastrado["eh_autor"]) echo "Autor da Comunicação Individual <b>".$trabalho_cadastrado["titulo"]."</b>.";
						elseif($trabalho_cadastrado["eh_co_autor"]) echo "Co-autor da Comunicação Individual <b>".$trabalho_cadastrado["titulo"]."</b>.";
						break;
					
					case 4:
						if($trabalho_cadastrado["eh_autor"]) echo "Autor do Pôster <b>".$trabalho_cadastrado["titulo"]."</b>.";
						elseif($trabalho_cadastrado["eh_co_autor"]) echo "Co-autor do Pôster <b>".$trabalho_cadastrado["titulo"]."</b>.";
						break;
				}
				echo "</li>";
			}//foreach
         ...
         <?php 
					...
					//print $registro_coordenador;
     				...
     				while($mostrar_trabalho=mysql_fetch_array($qr_trabalho)){ 
						...
						/*
						print "<pre>ID Simp Coord.: ";
							print_r($id_simposio_coord);
						print "</pre>";
						*/
