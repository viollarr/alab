...
mysql_select_db($banco); 
    ...
    $sql_busca = "SELECT name,block,endereco_res,complemento_res,bairro_res,cidade_res,estado_res,cep_res 
				  ...
				  WHERE block='0' AND id<>'62' ORDER BY name ASC";
...
setlocale(LC_ALL, 'pt_BR');
	...
	while($mostrar = mysql_fetch_array($query_busca)) {
		...
		switch($i%2) {
			...
			$html .= "<td width=308 style='width:308px;padding:7px 10px 7px 10px;height:153px;text-align:left'>
						  ...
						  <p class=MsoNormal ><span style='text-transform:lowercase;' >$endereco $complemento<o:p></o:p></span></p>

						  <p class=MsoNormal ><span style='text-transform:lowercase;' >$bairro - $cidade - $estado<o:p></o:p></span></p>
	...
	header('Content-Disposition: attachment; filename=associados-'.date('d-m-Y-His').'.doc');
