...
class dashboardViewDashboard extends JView
{
	function display($tpl = null)
	{
		...
		$desc['queue'] = '<ul><li>'.JText::_('QUEUE_DESC_CONTROL').'</li><li>'.JText::_('QUEUE_DESC_BOUNCE');
		if(!acymailing::level(3)){ $desc['queue'] .= ' <small style="color:red">'.JText::_('ONLY_FROM_ENTERPRISE').'</small>'; }
		$desc['queue'] .= '</li></ul>';
		$desc['config'] = '<ul><li>'.JText::_('CONFIG_DESC_CONFIG').'</li><li>'.JText::_('CONFIG_DESC_MODIFY').'</li><li>'.JText::_('CONFIG_DESC_PLUGIN').'</li></ul>';
		...
		$buttons[] = array('link'=>'autonews','level'=>1,'image'=>'autonewsletter','text'=>JText::_('AUTONEWS'));
		$buttons[] = array('link'=>'campaign','level'=>2,'image'=>'campaign','text'=>JText::_('CAMPAIGN'));
