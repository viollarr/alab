...
define('_ACA_DESC_CORE', compa::encodeutf('jNews é uma ferramenta de listas de mailing, envio de informativos, auto-respostas, e seguimento, para comunicação eficaz com os seus usuários e clientes. ' .
		'jNews, O Seu Parceiro De Comunicação!'));
define('_ACA_DESC_GPL', compa::encodeutf('jNews é uma ferramenta de listas de mailing, envio de informativos, auto-respostas, e seguimento, para comunicação eficaz com os seus usuários e clientes. ' .
		'jNews, O Seu Parceiro De Comunicação!'));
...
define('_ACA_INFO_MAILING_NOHTML', compa::encodeutf('Introduza o corpo do e-mail que você quer enviar para os assinantes que escolheram receber apenas mailings NÃO-HTML. <BR/> NOTA: se deixar em branco o jNews converterá automaticamente o texto HTML para apenas texto.'));
...
//Label CRON form
define('_ACA_LABEL_FREQ', compa::encodeutf('Agendar jNews?'));
define('_ACA_LABEL_FREQ_TIPS', compa::encodeutf('Clique em SIM se quiser utilizar isto para uma agenda jNews, NÃO para qualquer outra tarefa agendada.<br />' .
...
define('_ACA_NAME_AND_CONFIRM', compa::encodeutf('<b>[CONFIRM]</b> = Isto cria um link clicável onde o assinante pode confirmar a sua Inscrição. Isto é <strong>obrigatório</strong> para que o jNews funcione corretamente.<br />'
...
define('_ACA_SHOW_GUIDE_TIPS', compa::encodeutf('Mostra o Guia no início para ajudar novos usuários a criar um informativo, uma auto-resposta e parametrizar corretamente o jNews.'));
...
define('_ACA_SHOW_TIPS_TIPS', compa::encodeutf('Mostra dicas para ajudar os usuários a usar o jNews de forma eficaz.'));
...
define('_ACA_UPDATE_URL_WARNING', compa::encodeutf('AVISO! Não mude esta URL, a não ser que lhe seja pedido pela equipa técnica do jNews.<br />'));
...
define('_ACA_UPGRADE2', compa::encodeutf(' para o jNews no painel de atualizações.'));
...
define('_ACA_GUIDE_FIRST_ACA_STEP', compa::encodeutf('<p>O jNews tem muitas caracteristicas grandiosas e este assistente vai guia-lo através de um processo de 4 passos fáceis para que começe a enviar informativos e auto-respostas!<p />'));
...
define('_ACA_GUIDE_FIRST_ACA_STEP_UPGRADE', compa::encodeutf('O jNews proporciona-lhe uma maneira fácil de importar toda a informação de um sistema prévio de informativo.<br />' .
...
define('_ACA_GUIDE_FOUR_ACA_STEP', compa::encodeutf('<p><br />Aí está! Está agora pronto para comunicar de forma eficaz com os seus visitantes e usuários. Este assistente terminará assim que você introduzir um segundo mailing ou então pode desliga-lo no <a href="index2.php?option=com_jnewsletter&act=configuration" >Painel de Configuração</a>.' .
		...
		' Encontrará também muita informação sobre como comunicar de forma eficaz com os seus assinantes em <a href="http://www.acajoom.com/" target="_blank" >www.jNews.com</a>.' .
...
define('_ACA_SHOW_LOGIN_TIPS', compa::encodeutf('Selecione SIM para mostrar um formulário de login no sítio-principal do Painel de Controlo do jNews para que o usuário possa registar-se no site.'));
...
define('_ACA_CONTENTREP', compa::encodeutf('[SUBSCRIPTIONS] = Isto será substituído pelos links de inscrição.' .
		' Isto é <strong>obrigatório</strong> para que o jNews funcione corretamente.<br />' .
		'Se colocar algum outro conteúdo nesta caixa o mesmo será mostrado em todos os mailings correspondentes a esta Lista.' .
		' <br />Adicione a sua mensagem de inscrição no final. O jNews adicionará automaticamente um link para que o assinante altere a informação dele, e um link para remover-se da Lista.'));
...
define('_ACA_UPDATE_INSTALL', compa::encodeutf('<span style="color: rgb(255, 0, 0);">NOTÍCIA IMPORTANTE!</span> <br />Se está a fazer uma actualização a partir de uma versão anterior do jNews, precisa de atualizar a estrutura da sua base de dados clicando no botão seguinte (A sua informação ficará íntegra)'));
...
define('_ACA_JNEWSLETTER_CRON_DESC', compa::encodeutf('se não tem acesso à administração de tarefas agendadas no seu website, pode registar-se para uma Conta Tarefa Cron jNews Grátis em:'));
...
define( '_ACA_SHOW_SIGNATURE_TIPS', compa::encodeutf('Caso queira ou não promover o jNews no rodapé dos e-mails.'));
...
define('_ACA_PLEASE_LIC', compa::encodeutf('Por favor, entre em contato com o suporte técnico de jNews para atualizar sua licença ( license@acajoom.com ).'));

define('_ACA_DESC_PLUS', compa::encodeutf('jNews Plus é o primeiro auto-resposta sequencial para Joomla CMS.  ' . _ACA_FEATURES));
...
define('_ACA_ENTER_TOKEN_TIPS', compa::encodeutf('Por favor digite o código que você recebeu por e-mail, quando você comprou jNews. '));
...
define( '_ACA_JNEWSLETTER_CRON_DESC_ALT', compa::encodeutf('Se você não tem acesso a configuração da agenda do seu site, você pode usar o componente jCron (free) para criar uma tarefa agendada do seu site.'));
...
//since 1.5.6
define('_ACA_ADDEMAILREDLINK_TIPS', compa::encodeutf('Se você selecionar Sim, o e-mail do usuário será adicionado como um parâmetro no final da URL de seu redirecionamento (redireccionar a URL para seu módulo externo ou para jNews).<br/>Isso pode ser útil se você quiser executar um script especial em sua página de redirecionamento.'));
...
define('_ACA_ITEMID_TIPS', compa::encodeutf('Este itemId será adicionado ao seu jNews links.'));
