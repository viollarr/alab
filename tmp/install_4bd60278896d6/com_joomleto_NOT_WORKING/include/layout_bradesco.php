...
<a href="#" onClick="window.print()" >Veja as Instruções de Impressão abaixo e <br /> <b>Clique aqui para imprimir</b></a></DIV></TD></TR><TR><TD valign=top class=cp><DIV ALIGN="left">
<p>
...
</tr><tbody><tr><td colspan=5><img height=2 src=<? echo $site; ?>/imagens/2.gif width=666 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=298 height=13>Cedente</td><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=126 height=13>Agência/Código 
do Cedente</td><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=34 height=13>Espécie</td><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=53 height=13>Quantidade</td><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=120 height=13>Nosso 
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=cp valign=top width=298 height=12> 
...
Outras deduções</td><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=113 height=13>(+) 
...
Outros acréscimos</td><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=180 height=13>(=) 
...
</tr><tr><td valign=top width=7 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=7 border=0></td><td valign=top width=659 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=659 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct  width=7 height=12></td><td class=ct  width=564 >Demonstrativo</td><td class=ct  width=7 height=12></td><td class=ct  width=88 >Autenticação 
...
Pagável preferencialmente nas agências Bradesco ou Banco Postal</td><td class=cp valign=top width=7 height=12><img height=12 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=cp valign=top align=right width=180 height=12>
  <span class="campo">
  <?php echo $dadosboleto["data_vencimento"]?>
  </span></td>
</tr><tr><td valign=top width=7 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=7 border=0></td><td valign=top width=472 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=472 border=0></td><td valign=top width=7 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=180 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=472 height=13>Cedente</td><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=180 height=13>Agência/Código 
...
documento</td><td class=ct valign=top width=7 height=13> <img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=62 height=13>Espécie 
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=cp valign=top  width=113 height=12><div align=left> 
  <span class="campo">
...
<img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=53 height=13>Espécie</td><td class=ct valign=top height=13 width=7> 
...
<td valign=top width=7 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=1 border=0></td></tr></tbody></table></td><td valign=top width=468 rowspan=5><font class=ct>Instruções 
...
Outras deduções</td></tr><tr><td class=cp valign=top width=7 height=12> <img height=12 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=cp valign=top align=right width=180 height=12></td></tr><tr><td valign=top width=7 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=180 border=0></td></tr></tbody></table></td></tr><tr><td align=right width=10> 
...
<table cellspacing=0 cellpadding=0 border=0><tbody><tr> <td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=180 height=13>(+) 
Outros acréscimos</td></tr><tr> <td class=cp valign=top width=7 height=12><img height=12 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=cp valign=top align=right width=180 height=12></td></tr><tr><td valign=top width=7 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=180 border=0></td></tr></tbody></table></td></tr><tr><td align=right width=10><table cellspacing=0 cellpadding=0 border=0 align=left><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td></tr></tbody></table></td><td align=right width=188><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=180 height=13>(=) 
...
<td class=ct valign=top width=7 height=13><img height=13 src=<? echo $site; ?>/imagens/1.gif width=1 border=0></td><td class=ct valign=top width=180 height=13>Cód. 
baixa</td></tr><tr><td valign=top width=7 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=7 border=0></td><td valign=top width=472 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=472 border=0></td><td valign=top width=7 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=<? echo $site; ?>/imagens/2.gif width=180 border=0></td></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 border=0 width=666><TBODY><TR><TD class=ct  width=7 height=12></TD><TD class=ct  width=409 >Sacador/Avalista</TD><TD class=ct  width=250 ><div align=right>Autenticação 
