...
<table class="tab_admin">
        ...
        <td>
            <select name="ids_coordenadores[]" class="formulario">
				...
				foreach($participantes as $participante){ 
					...
					?>
            		<option value="<?php echo $participante["id"]; ?>" <?php print $selected; ?>><?php echo $participante["nome"]." | ".$participante["email"]; ?></option>
                <?php }//foreach ?>
            </select>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
              <input type="text" name="dia" value="<?php echo $simposio["dia"]; ?>" class="formulario" style="width:75px"/> 
              (DD/MM/AAAA)</td>
    </tr>
    <tr>
        <td>
        ...
        <td>
              <input type="text" name="horario" value="<?php echo $simposio["horario"]; ?>" class="formulario" style="width:75px; text-align:center"/> 
              (Ex.: 13h30min =&gt; 13:30)
        </td>
    </tr>
    <tr>
