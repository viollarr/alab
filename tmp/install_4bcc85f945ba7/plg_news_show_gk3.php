...
{	
	...
	function importLang()
	{
		...
		if(JFile::exists(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'language'.DS.$lang.'.lang.php'))
		{
			require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'language'.DS.$lang.'.lang.php');
		}
		else
		{
			require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'language'.DS.'en-GB.lang.php');
		}
	}
	...
	function addGroupForm()
	{
		...
		$LANG = new GKLang();
		// showing form
		require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'views'.DS.'add.group.php');
	}	
	...
	function editGroupForm()
	{
		...
		// showing form
		require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'views'.DS.'edit.group.php');
	}	
	// Editing group	
	function editGroup($apply=false)
	{
		...
		require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'class.image.php');
		$img = new Image();
		$db =& JFactory::getDBO();
		$plugin	= JRequest::getCmd('plugin');
		$option	= JRequest::getCmd('option');
	...
	function addSlideForm()
	{
		...
		$LANG = new GKLang();		
		// showing form
		require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'views'.DS.'add.slide.php');
	}
	// adding slide
	function addSlide()
	{
		...
		// creating thumbnails
		if($_POST['mediumThumbX'] != 0) $mW = $_POST['mediumThumbX']; 
		if($_POST['mediumThumbY'] != 0) $mH = $_POST['mediumThumbY'];
		if($_POST['smallThumbX'] != 0) $sW = $_POST['smallThumbX'];
		if($_POST['smallThumbY'] != 0) $sH = $_POST['smallThumbY'];
		// uploading image
	...
	function editSlideForm()
	{
		...
		// showing form
		require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'views'.DS.'edit.slide.php');
	}	
	// Editing slide
	...
	function previewGroup()
	{
		...
		// showing form
		require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'views'.DS.'preview.group.php');	
	}
	// preview for slide
	function previewSlide()
	{
		...
		// showing form
		require_once(JPATH_COMPONENT.DS.'configuration'.DS.'plugins'.DS.'plg_news_show_gk3'.DS.'views'.DS.'preview.slide.php');		
	}	
}
