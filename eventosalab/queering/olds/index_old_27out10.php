<?php
	...
	if ($_POST["insert"] == "true"){
		...
		if(sizeof($error)==0){
			$sql_insert = "insert into ev_participante(id_tipo_participante,id_evento,id_estado,id_cidade,id_formacao,nome,datanascimento,cpf,passaporte,email,senha,endereco,bairro,cep,telefone,modalidade_participacao,id_associado_alab,instituicao,presenca)
					       values('$tipo_participante','$id_evento','$estado','$cidade','$formacao_academica','$nome','$datanascimento_traco','$cpf','$passaporte','$email','$senha','$endereco','$bairro','$cep','$telefone','$modalidade_participacao','$id_user_joomla','$instituicao','nao');";	
  ...
  <div id="centro">
	...
	<? }else{ ?>
       <p><span class="txt_titulo_destaque">Fa&ccedil;a abaixo seu cadastro para este evento</span><br />
           <span class="txt_titulo_noticias_2">Caso j&aacute; seja cadastrado, fa&ccedil;a seu login ao lado.</span></p>
      ...
      <p>&nbsp;</p>
       <form id="form1" name="form1" method="post" action="">
         <table width="600" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td class="txt_topico_tabela"><strong>Estado</strong><span class="dados_obrigatorios">*</span></td>
           <td><label>
           ...
           <tr>
             <td class="txt_topico_tabela"><strong>Cidade</strong><span class="dados_obrigatorios">*</span></td>
             <td>
           ...
           <tr>
             <td class="txt_topico_tabela"><strong>CEP<span class="dados_obrigatorios">*</span></strong></td>
             <td><input name="cep" type="text" class="formulario" id="cep" size="20" maxlength="9" value="<?php if(sizeof($error)!= 0){ print $cep; } ?>" /></td>
           </tr>
           <tr>
