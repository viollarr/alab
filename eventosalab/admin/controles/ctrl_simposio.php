...
class ctrl_simposio extends ctrl_generico{
	...
	function abrir_edicao(){
		...
		/* Pegar Participantes */
		$sql_participantes = "SELECT id, nome, email FROM ev_participante 
			WHERE id_evento='".$this->id_evento."' AND (id_formacao=1 OR id_formacao=2) ORDER BY nome ASC"; // Doutores ou Doutorandos
