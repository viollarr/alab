...
<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>&amp;gtask=autonews" method="post" name="adminForm" autocomplete="off" enctype="multipart/form-data">
	<table width="100%">
		<tr>
			<td valign="top">
	...
	<input type="hidden" name="gtask" value="autonews" />
