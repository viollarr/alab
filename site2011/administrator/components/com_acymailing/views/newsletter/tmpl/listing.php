...
<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>&amp;gtask=newsletter" method="post" name="adminForm">
	<table>
		<tr>
			<td width="100%">
		...
		<tbody>
			...
			?>
				<tr class="<?php echo "row$k"; ?>">
					...
					<td align="center">
						<span id="<?php echo $visibleid ?>" class="spanloading"><?php echo $this->toggleClass->toggle($visibleid,(int) $row->visible,'mail') ?></span>
					</td>
					<td align="center">
