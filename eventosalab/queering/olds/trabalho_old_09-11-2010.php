	...
	*/
				...
				function envia_email_recebimento($params_email_recebimento){
					...
					*/
					...
					/*
					print "params_email_recebimento: <pre>";
						print_r($params_email_recebimento);
					print "</pre>";
					/**/
					...
					//print "<br>ipo trab: ".$sql;
					$result = mysql_query($sql, $conexao);
					$row    = mysql_fetch_array($result);
					$tipo_trabalho = $row[0];
				
					/* Autor */
					$sql = "SELECT email FROM ev_participante WHERE id=".$params_email_recebimento["id_autor"];
					//print "<br>autor: ".$sql;
					$result = mysql_query($sql, $conexao);
					$row    = mysql_fetch_array($result);
					$email_autor = $row[0];
