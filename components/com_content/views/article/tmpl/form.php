...
<tr>
	<td>
		<div style="float: left;">
			...
			<input class="inputbox_user" type="text" id="title" name="title" size="80" maxlength="100" value="<?php echo $this->escape($this->article->title); ?>" />
			<input class="inputbox_user" type="hidden" id="alias" name="alias" value="<?php echo $this->escape($this->article->alias); ?>" />
		</div>
...
<?php
echo $this->editor->display('text', $this->article->text, '100%', '500', '60', '15');
?>
</div>
</fieldset>
<br />
<fieldset>
<legend><b><?php echo JText::_('Sobre a publica&ccedil;&atilde;o'); ?></b></legend>
...
<!--<input type="hidden" name="sectionid" id="sectionid" value="3"/> <!-- 3 = Espaço do Associado -->
<!--<input type="hidden" name="catid" id="catid" value="18" /><!-- 18 = Documentos ALAB -->
</tr> 
...
<tr>
	<td class="key">
		<label for="created_by_alias">
			<?php echo JText::_( 'Nome do Autor' ); ?>:
		</label>
	</td>
	<td>
...
-->
<input type="hidden" name="publish_down" id="publish_down" value="Nunca" />
<!--<tr>
...
-->
<input type="hidden" name="access" id="access" class="inputbox" value="1" /> <!-- Registrado -->
<!--
<tr>
	<td class="key">
		<label for="ordering">
