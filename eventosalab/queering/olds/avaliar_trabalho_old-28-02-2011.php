			...
			************************************/
			if($id_tipo_trabalho == "3" || $id_tipo_trabalho == "4"){
                ...
                <style type="text/css">
					...
					.avaliar_trabalho .titulo, .avaliar_trabalho .resumo, .avaliar_trabalho .palavras_chave{color:#000; font-weight:normal; font-size:14px; text-align:justify; margin-bottom:10px;}
					...
					.questionario .observacao .titulo{margin-bottom:5px;}
					.questionario .observacao .texto textarea{border:1px solid #000; width:100%; height:70px;}
				...
				<div class="avaliar_trabalho">
                	...
                	<div class="titulo"><span>T&iacute;tulo:</span><?=$trabalho["titulo"]?></div>
                	<div class="resumo"><span>Resumo:</span><?=$trabalho["resumo"]?></div>
                    ...
                    <form id="form_trabalho" name="form_trabalho" method="post" action="salvar_avaliacao.php">
                      ...
                      <div class="questionario">
                              ...
                              foreach($perguntas as $pergunta){ ?>
                                  <div class="questao">
                                    ...
                                    <div class="questao_resp">
                                        <label><input type="radio" name="resposta_<?=$pergunta["id"]?>" value="sim" />Sim</label>
                                        <label><input type="radio" name="resposta_<?=$pergunta["id"]?>" value="nao" />N&atilde;o</label>
                                    </div>
                          ...
                          <div class="observacao">
                              ...
                              <div class="texto"><textarea name="observacao"></textarea></div>
                          </div>
                      </div>
