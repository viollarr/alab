...
?>
   <form action="<?php echo $mm_action_url ?>index.php?page=shop.cart&option=com_virtuemart&Itemid=<?php echo $Itemid ?>" method="post" name="addtocart" id="<?php echo uniqid('addtocart_') ?>" class="addtocart_form" <?php if( $this->get_cfg( 'useAjaxCartActions', 1 ) && !$notify ) { echo 'onsubmit="handleAddToCart( this.id );return false;"'; } ?>>
