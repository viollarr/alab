...
?>
	...
	if($qtd_participantes < 599){ //599
		?>
		<p>&nbsp;</p>
        <div id="boxes_inscrevase" style="display:none;  width:20%; height:35%;">
            <form action="controle.php" method="post" id="inscrevase">
				...
				?>
                <div class="titulo_boxes inscrevase">Tipo de Inscri&ccedil;&atilde;o</div><br />
                <div class="select_1">
                ...
                <div class="btn_send">
                	<input name="inscreva" id="send" type="submit" value="<?php techo('Enviar', 'Send'); ?>" class="botao_inscrevase" />
                </div>
            </form>
        </div>
