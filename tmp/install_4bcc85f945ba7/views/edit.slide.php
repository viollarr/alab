...
<tr>
	...
	<td><input type="text" name="mediumThumbX" value="<?php echo $mW; ?>" id="group_width" size="5" maxlength="4" />px</td>
</tr>
		
<tr>
	<td><?php echo $LANG->IMAGE_HEIGHT; ?></td>
	<td><input type="text" name="mediumThumbY" value="<?php echo $mH; ?>" id="group_height" size="5" maxlength="4" />px</td>
</tr>

<tr>
	<td><?php echo $LANG->THUMB_WIDTH; ?></td>
	<td><input type="text" name="smallThumbX" value="<?php echo $sW; ?>" id="thumb_width" size="5" maxlength="4" />px</td>
</tr>
		
<tr>
	<td><?php echo $LANG->THUMB_HEIGHT; ?></td>
	<td><input type="text" name="smallThumbY" value="<?php echo $sH; ?>" id="thumb_height" size="5" maxlength="4" />px</td>
</tr>
	...
	<td>
		<select name="article" id="slide_article">	
			<?php 
				...
				{
					echo '<option '.(($cat->id+200000000 == $article) ? 'selected="selected"' : '').' value="'.($cat->id+200000000).'" /> '.$LANG->CATEGORY_DEFAULT.' '.$cat->title;
				}
				//
				...
				{
					echo '<option '.(($sec->id+300000000 == $article) ? 'selected="selected"' : '').' value="'.($sec->id+300000000).'" /> '.$LANG->SECTION_DEFAULT.' '.$sec->title;
				}
			?>	
		</select>
	</td>
