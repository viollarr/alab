...

{
	...
	<div id="cpanel">
		...
		if ( $user->get('gid') > 24 ) {
			...
			$link = 'http://www.alab.org.br/administrator/components/maladiretawordpleno.php';

			quickiconButton( $link, 'icon-word-user.png', JText::_( 'Mala Direta Plenos' ) );
		...
		if ( $user->get('gid') > 24 ) {
			...
			$link = 'http://www.alab.org.br/administrator/components/maladiretawordalunos.php';

			quickiconButton( $link, 'icon-word-user.png', JText::_( 'Mala Direta Alunos' ) );
		...
		if ( $user->get('gid') > 24 ) {
			...
			$link = 'http://www.alab.org.br/administrator/components/maladiretaexcel.php';

			quickiconButton( $link, 'icon-excel-user.png', JText::_( 'Exportar Associados' ) );
		...
		if ( $user->get('gid') > 24 ) {
			...
			$link = 'http://www.alab.org.br/administrator/components/maladiretaexcelalunos.php';

			quickiconButton( $link, 'icon-excel-user.png', JText::_( 'Exportar S&oacute;cios Alunos' ) );
		...
		if ( $user->get('gid') > 24 ) {
			...
			$link = 'http://www.alab.org.br/administrator/components/maladiretaexcelplenos.php';

			quickiconButton( $link, 'icon-excel-user.png', JText::_( 'Exportar S&oacute;cios Plenos' ) );
		...
		if ( $user->get('gid') > 24 ) {
			...
			$link = 'http://alab.org.br/administrator/index.php?option=com_acymailing&ctrl=newsletter';

			quickiconButton( $link, 'icon-48-email.png', JText::_( 'Enviar Email para os inadimplentes' ) );
