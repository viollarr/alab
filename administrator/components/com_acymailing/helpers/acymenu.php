...
class acymenuHelper{
	function display($selected = ''){
		...
		if(acymailing_isAllowed($config->get('acl_configuration_manage','all'))){
			$mainmenu['config'] = array(JText::_('CONFIGURATION'), 'index.php?option=com_acymailing&ctrl=cpanel','acyicon-16-config');
			$submenu['config'] = array();
			$submenu['config'][] = array(JText::_('CONFIGURATION'), 'index.php?option=com_acymailing&ctrl=cpanel','acyicon-16-config');
