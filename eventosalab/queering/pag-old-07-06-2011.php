<?php
	...
	// Para puxar as imagens do lugar certo! Ou seja, sair de eventosalab e entrar em images/stories/
	$conteudo = str_replace("<img src=\"images/stories/", "<img src=\"../images/stories/", $conteudo);
