...
class ctrl_presenca extends ctrl_generico {
    ...
    function salvar_presenca() {
        ...
        $this->pr('presente', $presente);
        $this->pr('id_participante', $id_participante);
        $this->pr('id_trabalho', $id_trabalho);
        $this->pr('tipo_certificado', $tipo_certificado);

        exit("salvar_presenca()");
