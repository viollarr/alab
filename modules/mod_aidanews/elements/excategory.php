 ...
 */
class JElementExcategory extends JElement {
	...
	function fetchElement($name, $value, &$node, $control_name){
		...
		if( $version->RELEASE == '1.6' ){
			...
			$categories = array();
			$categories[0]->id = '';
			$categories[0]->title = JText::_("SELECTNONE");
			...
			return JHTML::_( 'select.genericlist', 
							 ...
							 'class="inputbox" style="width:95%;" multiple="multiple" size="5"',
							 'id', 
							 'title', 
							 $value );
		}
