        ...
        <tr>
            ...
            <td>
       	    <?php 
				...
				?>
                <input type="text" name="data_inicio" value="<?php echo $data_ini_format; ?>" class="formulario" style="width:80px; text-align:center;"/>
                &nbsp;  (Ex: dd/mm/aaaa)            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
   	      <?php 
				...
				?>
                <input type="text" name="data_fim" value="<?php echo $data_fim_format; ?>" class="formulario" style="width:80px; text-align:center;"/>
                &nbsp;  (Ex: dd/mm/aaaa)            </td>
        </tr>
        <tr>
            <td>
