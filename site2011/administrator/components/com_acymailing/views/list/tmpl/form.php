...
<form action="index.php?option=com_acymailing&amp;gtask=list" method="post" name="adminForm" autocomplete="off">
	<table class="adminform" cellspacing="1" width="100%">
		...
		<tr>
			...
			<td>
				...
				echo ' <a class="modal" title="'.JText::_('EDIT',true).'"  href="index.php?option=com_acymailing&amp;tmpl=component&amp;gtask=subscriber&amp;task=choose" rel="{handler: \'iframe\', size: {x: 800, y: 500}}"><img src="'.ACYMAILING_LIVE.'images/M_images/edit.png" alt="'.JText::_('EDIT',true).'"/></a>';
				?>
			</td>
			<td>
