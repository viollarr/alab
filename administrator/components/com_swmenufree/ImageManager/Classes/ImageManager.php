...
global $mainframe;
 ...
 require_once($absolute_path."/administrator/components/com_swmenufree/ImageManager/Classes/Files.php");
...
if($path=="/"){
		$path = Files::fixPath("/modules/mod_swmenufree/images".$path);
}else{
