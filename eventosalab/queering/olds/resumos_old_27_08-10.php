<?php
	...
	//RESUMOS soltos
	$sql_resumos_participante = "SELECT ev_tipo_trabalho.nome AS tipodetrabalho, ev_resumo.titulo AS tituloresumo, ev_resumo.id_linha_tematica, ev_resumo.id_simposio, ev_resumo.id_comunicacao_coordenada, ev_resumo.autor, ev_resumo.co_autor, ev_resumo.resumo, ev_resumo.palavras_chave   
					FROM ev_resumo 
					INNER JOIN ev_tipo_trabalho	ON ev_resumo.id_tipo_trabalho = ev_tipo_trabalho.id 
				    WHERE id_apresentador='".$_SESSION['id_participante']."' AND ev_resumo.id_evento='".$_SESSION['id_evento']."'";
	$resumos_participante = mysql_query($sql_resumos_participante, $conexao) or die(mysql_error());
...
<div id="tudo">
		...
		<div id="menu_eventos_alab">
            <ul>
                <li><a href="principal.php">Envio de Trabalho</a></li>
                <li><a href="participante.php">Área do Participante</a></li>
            </ul>
        </div>
		<div class="clear"></div>
  ...
  <div id="centro">
	<p>&nbsp;</p>
    <div id="artigo">
       <span class="menuinterno"><a href="participante.php">Alterar Dados</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="resumos.php">Resumos enviados</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="cartaaceite.php">CartA de aceite</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="certificadoparticipacao.php">Certificado de participação</a></span> 
      <p>&nbsp;</p>
