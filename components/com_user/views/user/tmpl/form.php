...
jQuery(document).ready(function() {
	...
	jQuery("#button_validador").removeAttr("onClick");
...
// PARA  EXIBIR E OCULTAR OS TIPOS DE RESIDENCIAS  inputbox_user required
	...
	if(jQuery("#escolha3").is(":checked")){
		...
		jQuery('#id_estado_res').attr("class","required");
		jQuery('#id_cidade_res').attr("class","required");
		...
		jQuery('#estado_res').attr("class","required");
		jQuery('#cidade_res').attr("class","required");
	}
	else{
		jQuery('#estrangeiro').hide();
		jQuery('#estrangeiro1').hide();
		...
		jQuery('#nacional2').hide();
		jQuery('#nacional3').hide();
		jQuery('#tipo_residencia').attr("class","invalid");
		jQuery('#id_estado_res').attr("class","required");
		jQuery('#id_cidade_res').attr("class","required");
		jQuery('#estado_res').attr("class","required");
		jQuery('#cidade_res').attr("class","required");
		alert('Atualize seus dados residenciais.');
	}
	...
	jQuery('#escolha3').click(function(){
		...
		jQuery('#id_estado_res').attr("class","required");
		jQuery('#id_cidade_res').attr("class","required");
		jQuery('#estado_res').removeAttr("class");
		jQuery('#cidade_res').removeAttr("class");
		jQuery('#estado_res').attr("class","inputbox_user");
		jQuery('#cidade_res').attr("class","inputbox_user");
	});
	jQuery('#escolha4').click(function(){
		...
		jQuery('#estado_res').attr("class","required");
		jQuery('#cidade_res').attr("class","required");
		jQuery('#id_estado_res').removeAttr("class");
		jQuery('#id_cidade_res').removeAttr("class");
		jQuery('#id_estado_res').attr("class","inputbox_user");
		jQuery('#id_cidade_res').attr("class","inputbox_user");
	});	
...
jQuery(function(){
	...
	jQuery('#id_estado_res').change(function(){
		if( jQuery(this).val() ) {
			...
			//jQuery.getJSON('administrator/components/com_users/views/user/tmpl/cidades.php?search=',{cod_estados: jQuery(this).val(), ajax: 'true'}, function(j){ 	// Para usar no ambiente local use este
  ...
  <td colspan="2"><table border="0" width="460">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Institui&ccedil;&atilde;o</span></td>
      ...
      <tr >
        ...
        <td><input class="inputbox_user" name="instituicao_GR" type="text" id="instituicao_GR" value="<?php echo $this->escape($this->user->get( 'instituicao_GR' ));?>" size="20" maxlength="100" />        </td>

        <td><input class="inputbox_user" name="curso_GR" type="text" id="curso_GR" value="<?php echo $this->escape($this->user->get( 'curso_GR' ));?>" size="18" maxlength="100" />        </td>

        <td><input class="inputbox_user" name="cidade_GR" type="text" id="cidade_GR" value="<?php echo $this->escape($this->user->get( 'cidade_GR' ));?>" size="12" maxlength="50" />        </td>

        <td><input class="inputbox_user" name="ano_conclusao_GR" type="text" id="ano_conclusao_GR" value="<?php echo $this->escape($this->user->get( 'ano_conclusao_GR' ));?>" size="5" maxlength="4" /></td>

      </tr>

      <tr >

        <td>Especializa&ccedil;&atilde;o</td>

        <td><input class="inputbox_user" name="instituicao_ES" type="text" id="instituicao_ES" value="<?php echo $this->escape($this->user->get( 'instituicao_ES' ));?>" size="20" maxlength="100" />        </td>

        <td><input class="inputbox_user" name="curso_ES" type="text" id="curso_ES" value="<?php echo $this->escape($this->user->get( 'curso_ES' ));?>" size="18" maxlength="100" />        </td>

        <td><input class="inputbox_user" name="cidade_ES" type="text" id="cidade_ES" value="<?php echo $this->escape($this->user->get( 'cidade_ES' ));?>" size="12" maxlength="50" />        </td>

        <td><input class="inputbox_user" name="ano_conclusao_ES" type="text" id="ano_conclusao_ES" value="<?php echo $this->escape($this->user->get( 'ano_conclusao_ES' ));?>" size="5" maxlength="4" />        </td>
      ...
      <tr >
        ...
        <td><input class="inputbox_user" name="instituicao_MT" type="text" id="instituicao_MT" value="<?php echo $this->escape($this->user->get( 'instituicao_MT' ));?>" size="20" maxlength="100" />        </td>

        <td><input class="inputbox_user" name="curso_MT" type="text" id="curso_MT" value="<?php echo $this->escape($this->user->get( 'curso_MT' ));?>" size="18" maxlength="100" />        </td>

        <td><input class="inputbox_user" name="cidade_MT" type="text" id="cidade_MT" value="<?php echo $this->escape($this->user->get( 'cidade_MT' ));?>" size="12" maxlength="50" />        </td>

        <td><input class="inputbox_user" name="ano_conclusao_MT" type="text" id="ano_conclusao_MT" value="<?php echo $this->escape($this->user->get( 'ano_conclusao_MT' ));?>" size="5" maxlength="4" />        </td>
      ...
      <tr>
        ...
        <td><input class="inputbox_user" name="instituicao_DR" type="text" id="instituicao_DR" value="<?php echo $this->escape($this->user->get( 'instituicao_DR' ));?>" size="20" maxlength="100" /></td>

        <td><input class="inputbox_user" name="curso_DR" type="text" id="curso_DR" value="<?php echo $this->escape($this->user->get( 'curso_DR' ));?>" size="18" maxlength="100" /></td>

        <td><input class="inputbox_user" name="cidade_DR" type="text" id="cidade_DR" value="<?php echo $this->escape($this->user->get( 'cidade_DR' ));?>" size="12" maxlength="50" /></td>
...
<tr>
  ...
  <td><strong>Cadastro de Endere&ccedil;os</strong> </td>
...
<tr id="nacional">
    ...
    <td>
    	<input type="hidden" name="estado_id_res" id="estado_id_res" value="<?php echo $this->user->get('id_estado_res');?>" />
...
<?php //if(isset($this->params)) :  echo $this->params->render( 'params' ); endif; ?>
	...
	<button class="button validate" id="button_validador" type="submit" onclick="submitbutton( this.form );return false;"><?php echo JText::_('Save'); ?></button>
