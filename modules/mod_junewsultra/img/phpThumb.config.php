...
$jucache = str_replace(array('/plugins/content/jumultithumb', '\plugins\content\jumultithumb'),'', dirname(__FILE__));

$PHPTHUMB_CONFIG['cache_directory'] = $jucache .'/cache/mod_img_junewsultra/';

MakeDirectory($dir = $PHPTHUMB_CONFIG['cache_directory'], $mode = 0777);

copy( $jucache .'/cache/index.html', $jucache .'/cache/mod_img_junewsultra/index.html');
...
$PHPTHUMB_CONFIG['cache_directory_depth'] = 1; // If this larger than zero, cache structure will be broken into a broad directory structure based on cache filename. For example "cache_src012345..." will be stored in "/0/01/012/0123/cache_src012345..." when (cache_directory_depth = 4)
...
$PHPTHUMB_CONFIG['cache_source_directory'] = $jucache .'/cache/mod_img_junewsultra/source/';

MakeDirectory($dir = $PHPTHUMB_CONFIG['cache_source_directory'], $mode = 0777);

copy( $jucache .'/cache/index.html', $jucache .'/cache/mod_img_junewsultra/source/index.html');
...
$PHPTHUMB_CONFIG['nohotlink_erase_image']       = false;                                     // if true thumbnail is covered up with $PHPTHUMB_CONFIG['nohotlink_fill_color'] before text is applied, if false text is written over top of thumbnail
