...
<!--
	...
	function insertTag(){
		...
		window.top.document.getElementById('link<?php echo $this->controlName.$this->fieldName; ?>').href = 'index.php?option=com_acymailing&tmpl=component&gtask=chooselist&task=<?php echo $this->fieldName; ?>&control=<?php echo $this->controlName; ?>&values='+tag;
...
<div style="float:right;margin-bottom : 10px">
	<button id='insertButton' onclick="insertTag(); return false;"><?php echo JText::_('APPLY'); ?></button>
</div>
