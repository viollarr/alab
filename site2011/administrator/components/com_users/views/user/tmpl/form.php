	...
	<div class="col width-45">
		...
		<legend><?php echo JText::_( 'User Details' ); ?></legend>
			<table class="admintable" cellspacing="1">
                ...
                <tr>
					<td class="key">
						<label for="Anuidade2009">
							<?php echo JText::_( 'Anuidade 2009' ); ?>						</label>					</td>
					<td>
						<input type="radio" name="Anuidade2009" value="Sim" <?php if ($this->escape($this->user->get( 'Anuidade2009' ))=="Sim"){ print "checked";}?>  />Sim 
                        &nbsp;
    					<input type="radio" name="Anuidade2009" value="Não" <?php if ($this->escape($this->user->get( 'Anuidade2009' ))=="Não"){ print "checked";}?> />Não
