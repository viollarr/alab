...
<form action="controle.php" method="post">
    <input type="hidden" name="ctrl" value="paper" />
    ...
    <table class="tab_admin">
        <tr>
            ...
            <td>
                  <input type="text" name="titulo" value="<?php echo $paper["titulo"]; ?>" class="formulario" style="width:375px;" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <select name="id_linha_tematica" class="formulario">
					...
					foreach($linhas_tematicas as $linha_tematica){ 
						$selected = "";
						if($linha_tematica["id"]==$paper["id_linha_tematica"]) $selected="selected"; ?>
        ...
        <tr>
            ...
            <td>
            	<textarea name="resumo" class="formulario" style="width:99%; height:150px" ><?php echo $paper["resumo"]; ?></textarea>
                <br />
        ...
        <tr>
            ...
            <td>
              <input type="text" name="palavras_chave" value="<?php echo $paper["palavras_chave"]; ?>" class="formulario" style="width:375px"/>
(Tr&ecirc;s palavras separadas por &quot;<strong>;</strong>&quot;)            </td>
            ...
            <td>
                <select name="autor" class="formulario">
					...
					foreach($participantes as $participante){ 
						$selected = "";
						if($participante["id"]==$paper["autor"]) $selected="selected"; ?>
        ...
        <tr>
            ...
            <td>
                <select name="co_autor" class="formulario">
					...
					foreach($participantes as $participante){ 
						$selected = "";
						if($participante["id"]==$paper["co_autor"]) $selected="selected"; ?>
                        <option value="<?php echo $participante["id"]; ?>" <?php echo $selected; ?>><?php echo $participante["name"]." | ".$participante["email"]; ?></option>
                    <?php }//foreach ?>
	            </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <select name="co_autor2" class="formulario">
					...
					foreach($participantes as $participante){ 
						$selected = "";
						if($participante["id"]==$paper["co_autor2"]) $selected="selected"; ?>
                        <option value="<?php echo $participante["id"]; ?>" <?php echo $selected; ?>><?php echo $participante["name"]." | ".$participante["email"]; ?></option>
                    <?php }//foreach ?>
	            </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <select name="co_autor3" class="formulario">
					...
					foreach($participantes as $participante){ 
						$selected = "";
						if($participante["id"]==$paper["co_autor3"]) $selected="selected"; ?>
                        <option value="<?php echo $participante["id"]; ?>" <?php echo $selected; ?>><?php echo $participante["name"]." | ".$participante["email"]; ?></option>
                    <?php }//foreach ?>
	            </select>
            </td>
        ...
        <tr>
            ...
            <td>
                  <input type="text" name="dia" value="<?php echo $paper["dia"]; ?>" id="dia" class="formulario" style="width:75px"/> 
                  (DD/MM/AAAA) 
          </td>
   	  </tr>
        <tr>
            ...
            <td>
                  <input type="text" name="horario" value="<?php echo $paper["horario"]; ?>" id="horario" class="formulario" style="width:75px; text-align:center"/> (Ex.: 13h30min =&gt; 13:30)
          </td>
   	  </tr>
        <tr>
            <td>
            ...
            <td>
                  <input type="text" name="local" value="<?php echo $paper["local"]; ?>" class="formulario" style="width:375px"/> 
          </td>
   	  </tr>
    </table>
