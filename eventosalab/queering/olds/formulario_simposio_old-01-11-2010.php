    ...
    <table width="600" border="0">
     <tr>
      ...
      <tr>
        ...
        <td width="460"><input name="titulo[]" type="text" class="formulario" id="titulo[]" size="70" maxlength="250" value="" /></td>
      </tr>
      ...
      <tr>
        ...
        <td><input name="coautor[]" type="text" class="formulario" id="coautor[]" size="30" maxlength="70" />
          <span class="txt_topico_tabela"><b>&nbsp;E-mail:</b></span>
      ...
      <tr>
        <td class="txt_topico_tabela">&nbsp;</td>
        <td>
          <textarea name="resumo[]" cols="69" rows="10" class="formulario" id="resumo<?=$i;?>" onkeyup="counterUpdate('resumo<?=$i;?>', 'WordCount<?=$i;?>', 2000);"></textarea>
        </td>
      </tr>
      <tr>
        <td class="txt_topico_tabela"><strong>Palavras-chave<span class="dados_obrigatorios">*</span></strong></td>
        <td><input name="palavras[]" type="text" class="formulario" id="palavras" size="70" maxlength="250" value="" /></td>
      </tr>
      <tr>
        <td class="txt_topico_tabela">&nbsp;</td>
        <td><span class="txt_desc_tabela">3 palavras-chave separadas por ponto e v&iacute;rgula</span></td>
