...
<body>
<div id="tudo">
    <div id="boxes" style="display:none; width:30%;">
    	<form action="controle.php" enctype="multipart/form-data" method="post">
            ...
            <div class="titulo_boxes titulo_boxes_modal">Atualize seus dados</div><br />
        	<div id="dialog2" class="window" style="padding-left:10px;"><span style="font-weight:bold;">Tipo de Residência: </span>
            	...
            	<div id="estado_nacional" style="margin-top:15px;"><label style="font-weight:bold;">Estado: </label>
            	...
            	<div id="estado_outro"  style="margin-top:15px;"><label style="font-weight:bold;">Estado: </label>
     ...
     <?php if ($modalidade_participacao==1) {//1 -> com trabalho //1 -> é associado alab?>
       ...
       <div id="box_trabalhos">
		...
		$sql = "SELECT id, id_tipo_trabalho, titulo FROM ev_resumo 
			WHERE (autor='".$_SESSION['id_participante']."' OR co_autor='".$_SESSION['id_participante']."') AND id_evento='".$_SESSION['id_evento']."' ORDER BY id ASC";
