...
class testreceiverType{
	...
	function testreceiverType(){
		...
		if(version_compare(JVERSION,'1.6.0','<')){
			...
			$this->values[] = JHTML::_('select.option', 'gid_19',JText::_('AUTHOR'));
			...
			$this->values[] = JHTML::_('select.option', 'gid_31',JText::_('Queering Paradigms IV'));
			
			$this->values[] = JHTML::_('select.option', 'gid_40',JText::_('Inadimplentes'));
			
			// Comentado por Victor

/*			$this->values[] = JHTML::_('select.option', 'gid_32',JText::_('Inadimplente 2010'));

			$this->values[] = JHTML::_('select.option', 'gid_33',JText::_('Inadimplente 2011'));

			$this->values[] = JHTML::_('select.option', 'gid_34',JText::_('Inadimplente 2012'));

			$this->values[] = JHTML::_('select.option', 'gid_35',JText::_('Inadimplente 2010 e 2011'));

			$this->values[] = JHTML::_('select.option', 'gid_37',JText::_('Inadimplente 2010 e 2012'));

			$this->values[] = JHTML::_('select.option', 'gid_38',JText::_('Inadimplente 2011 e 2012'));

		    $this->values[] = JHTML::_('select.option', 'gid_36',JText::_('Inadimplente 2010 2011 2012'));
*/
