...
(Tr&ecirc;s palavras separadas por &quot;<strong>;</strong>&quot;)            </td>
        ...
        <tr>
            ...
            <td>
                  <input type="text" name="dia" value="<?php echo $poster["dia"]; ?>" class="formulario" style="width:75px"/> 
                  (DD/MM/AAAA) 
          </td>
   	  </tr>
        <tr>
            ...
            <td>
                  <input type="text" name="horario" value="<?php echo $poster["horario"]; ?>" class="formulario" style="width:75px; text-align:center"/> (Ex.: 13h30min =&gt; 13:30)
          </td>
   	  </tr>
        <tr>
            <td>
