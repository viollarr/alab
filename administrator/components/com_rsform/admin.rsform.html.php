		   ...
		   <tr>
		      <td align="right">
				...
				<?php echo _RSFORM_BACKEND_SUBMISSIONS_MANAGE_FILTER;?>
		         ...
		         <input type="button" name="filterBtn" value="<?php echo _RSFORM_BACKEND_SUBMISSIONS_MANAGE_FILTER_BTN;?>" onclick="createFilter();" />
      		...
      		<td width="50%" valign="top" class="thisform">
      			<table width="100%" class="thisform2" border="1">
      				...
      				<tr class="thisform2">
	      				...
	      				<td align="center" height="100px" width="33%" class="thisform2">
				            <a href="http://www.rsjoomla.com/index.php/Customer-Support.html" style="text-decoration:none;" title="<?php echo _RSFORM_BACKEND_CPANEL_SUPPORT;?>" target="_blank">
...
//////////////////////////////////////// UPDATES ////////////////////////////////////////
    ...
    ?>
		...
		<table class="adminform">
		    ...
		    <tr>
			    <td>
				    <iframe src="http://www.rsjoomla.com/index.php?option=com_rshelp&task=rev.check&sess=<?php echo rsform_HTML::genKeyCode();?>&amp;rev=<?php echo _RSFORM_REVISION;?>&amp;joomla=<?php echo $RSadapter->version;?>&amp;Itemid=43" style="border:0px solid;width:100%;height:18px;" scrolling="no" frameborder="no"></iframe>
			    </td>
		    </tr>
		</table>
        <br />
