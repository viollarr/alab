...
Joomla! 1.0 includes or is derivative of works distributed under the licenses listed below.
The full text for most of the licenses listed below can be found in the LICENSES.php file.
Some of the licenses could not be copied without permission. In those cases, URLs are
provided to the full text of the license. The original copyright notices have been preserved
within the respective files and or packages.  Please refer to the specific files and/or
packages for more detailed information about the authors, copyrights, and licenses.
---------------------------------------------------------------------------------------------
...
-----
Author:		Fabien Marty
Copyright:	Copyright (C) Fabien Marty
License:	GNU Lesser General Public License (LGPL)
