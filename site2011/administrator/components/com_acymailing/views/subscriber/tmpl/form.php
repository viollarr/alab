...
<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>&amp;gtask=subscriber" method="post" name="adminForm" autocomplete="off">
	<div>
					...
					<td width="50%" align="left">
						<table class="admintable" cellspacing="1">
							...
							<tr>
								...
								<td>
									<?php echo empty($this->subscriber->usertype) ? JText::_('VISITOR') : $this->subscriber->usertype;?>
								</td>
							</tr>
							<tr>
								<td class="key">
			...
			<table class="adminlist" cellspacing="1" align="center">
				<thead>
					<tr>
						...
						<th  class="title" nowrap="nowrap" width="450">
	...
	<input type="hidden" name="gtask" value="subscriber" />
