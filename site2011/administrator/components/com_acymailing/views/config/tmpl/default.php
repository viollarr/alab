...
<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>&amp;gtask=config" method="post" name="adminForm" autocomplete="off">
	<?php
		...
		echo $this->tabs->startPanel( JText::_( 'FILES' ), 'config_files');
		include(dirname(__FILE__).DS.'files.php');
		echo $this->tabs->endPanel();
	...
	<input type="hidden" name="gtask" value="config" />
