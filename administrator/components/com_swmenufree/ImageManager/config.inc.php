...
$IMG_ROOT = $BASE_DIR.$BASE_ROOT;
$IMG_URL = $BASE_URL.$BASE_ROOT;
...
*/
$IMConfig['thumbnail_width'] = 160;
$IMConfig['thumbnail_height'] = 160;
