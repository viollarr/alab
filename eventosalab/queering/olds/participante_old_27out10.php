         ...
         <table width="600" border="0" cellspacing="0" cellpadding="0">
           ...
           <td><label>
               <select name="estado" class="formulario" id="estado">
                    ...
                    <option value="<?php print $estado;?>"><?php print htmlentities($nome_estado); ?></option>
                    <?php } else{ ?>
                    <option value="<?php print $p['id_estado'] ?>"><?php print $nome_estado_atual; ?></option>
             ...
             <td>
			  <select name="cidade" class="formulario" id="cidade">
                 ...
                 <?php 
    	             ...
    	             <option  value="<?php print $p['id_cidade'] ?>" selected="selected"><?php print $nome_cidade_atual; ?></option>
                 <?php } ?>
              </select>              </td>
           </tr>
           <tr>
