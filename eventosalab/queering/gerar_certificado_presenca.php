...
switch($categoria_certificado){
	...
	case 'coordenacao_sessao': 
		...
		$certificado['padding_left'] = '-43px';
		$certificado['titulo_pdf'] = 'QP4_Certificate_of_Contribution';
...
<body>
	<div style="margin: 40px 0 0 0">
		<img src="certificados/'.$certificado['imagem'].'"  width="100%" />
	</div>
...
//echo "<br/>"; print_r($html); echo "</pre><br/>";
