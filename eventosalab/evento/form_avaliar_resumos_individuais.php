...
<div class="avaliar_trabalho">
    <p class="txt_categorias">
        <b>
          ...
          switch($id_tipo_trabalho){
              case 4: print "P&ocirc;ster"; $tipo_trabalho = "poster"; break;
			  case 5: print "Paper"; $tipo_trabalho = "paper"; break;
          }
          ?>
        </b>
    </p>
    ...
    <form id="form_trabalho" name="form_trabalho" method="post" action="salvar_avaliacao.php">
        ...
        <input type="hidden" name="id_evento" value="<?=$trabalho['id_evento']?>" />
      <div class="questionario">
          <div class="titulo">Question&aacute;rio</div>
          <div class="perguntas">
              <?php
              $sql = "SELECT * FROM ev_pergunta WHERE id_tipo_trabalho = '".$trabalho["id_tipo_trabalho"]."' AND id_evento = '".$trabalho['id_evento']."' ORDER BY ordem ASC";
