        	...
        	<td style="vertical-align:top;width:75%;">
                    ...
                    <table summary="image" width="100%">
                    	...
                    	<tr id="attributes-margin">
	                        ...
	                        <td colspan="3">
	                        	<label for="margin_top"><?php echo WFText::_('WF_OPTION_TOP');?></label><input type="text" id="margin_top" value="" size="3" maxlength="3" onchange="ImageManagerDialog.setMargins();" />
                    	...
                    	<tr id="attributes-border">
	                    	...
	                    	<td colspan="3">
	                    		...
	                    		<input id="border_color" class="color" type="text" value="#000000" size="9" onchange="TinyMCE_Utils.updateColor(this);ImageManagerDialog.updateStyles();" />
	                    	</td>
	                    </tr>
                </table>
                </fieldset>
