 ...
 */
var WFAggregator=WFExtensions.add('Aggregator',{aggregators:{},add:function(name,o){this.aggregators[name]=o||{};},get:function(name){return this.aggregators[name]||null;},setup:function(){var self=this;tinymce.each(this.aggregators,function(o,k){return self._call(o,'setup');});},getTitle:function(name){var f=this.get(name);if(f){return f.title;}
