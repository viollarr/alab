...
<form action="<?php echo acymailing::completeLink('archive&listid='.$this->list->listid); ?>" method="post" name="adminForm">
	...
	?>
		<a href="<?php echo acymailing::completeLink('newsletter&task=add&listid='.$this->list->listid); ?>"><img src="images/M_images/new.png"/></a>
	<?php } ?>
	...
	<input type="hidden" name="gtask" value="archive" />
