		...
		<tbody>
			...
			?>
				<tr class="<?php echo "row$k"; ?>" id="<?php echo $id; ?>">
					...
					<td align="center" style="text-align:center">
						<?php
						$text = '<b>'.JText::_('FROM_NAME',true).' : </b>'.str_replace(array("'"),array("&#039;"),$row->fromname);
						$text .= '<br/><b>'.JText::_('FROM_ADDRESS',true).' : </b>'.$row->fromemail;
						$text .= '<br/><br/><b>'.JText::_('REPLYTO_NAME',true).' : </b>'.str_replace(array("'"),array("&#039;"),$row->replyname);
						$text .= '<br/><b>'.JText::_('REPLYTO_ADDRESS',true).' : </b>'.$row->replyemail;
						echo JHTML::_('tooltip', $text, '', '', $row->fromname);
						?>
					</td>
					<td align="center" style="text-align:center">
