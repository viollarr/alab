                    ...
                    <div id="menu_secundario">
                            ...
                            <?php if ($exibir_box_logout){ ?>
								...
								<?php if($this->countModules("menu_interno_restrito")!=0) { ?>
									...
									$valores = array("Honorario"=>"", "Pleno"=>"104.50", "Aluno"=>"54.50");
									...
									if(!empty($valor_documento)){
										...
										<ul style="margin-top:-2px;"><li>
											...
											<a href="http://www.alab.org.br/index2.php?
                                                ...
                                                &acrescimos=<?php print $acrescimos;?>" target="_blank">Gerar Boleto para pagamento de anuidade</a>
...
<?php 
 ...
 ?>
        ...
        <div id="lado_direito">
			...
			<div id="pagar_evento">
				<div class="titulo_boxes"><h2>Queering Paradigms IV</h2></div>
				<jdoc:include type="modules" name="user_pagamento_evento" style="xhtml" />				
			</div>
			
			
			<?php if($this->countModules('carrinho')) : ?>
				<div id="carrinho">
					<div class="titulo_boxes"><h2>Carrinho</h2></div>
					<jdoc:include type="modules" name="carrinho" style="xhtml" />				
				</div>
			<?php endif; ?>
