...
class plgContentSimplePopUp extends JPlugin
{
    ...
    */
    ...
    {
            JLoader::register('SPUAjaxServlet' , SPU_PATH.DS.'spuajaxservlet.php');
	...
	function render( &$matches )
    {
        ...
        if (is_readable(SPU_PATH.DS.'default.php') && $this->spuindex == $this->spuindexinit && strlen($this->popupanchor) == 0) {
			...
			//include(SPU_PATH.DS.'default-multi.php');
			echo plgContentSimplePopUp::addPopUp($this->spuindex);
		} else {
	...
	function addPopUp($idx) {
		...
		echo '		$jqspu("#'.$this->popupname.'").fancybox({', chr(10);
