...
define( 'URL', 'http://alab.org.br/site2011/' );
define( 'SECUREURL', 'http://alab.org.br/site2011/' );
...
define('VM_ONCHECKOUT_LEGALINFO_SHORTTEXT', 'Política de Devoluções
...
Para obter mais informações sobre cancelamento de pedidos e devolução de itens, veja a página de Nossa Política de Devoluções.');
...
define('DOWNLOADROOT', '/home/storage/d/64/7f/alab1/public_html/site2010/site2011/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', '9dfb7009d367e1ed1cd9879dd228b25f');
...
define('PSHOP_IMG_WIDTH', '378');
define('PSHOP_IMG_HEIGHT', '112');
...
'CHECK_OUT_GET_SHIPPING_METHOD'=>array('order'=>1,'enabled'=>0),
