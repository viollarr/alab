...
class LinkrInstaller extends JObject
{
	...
	function dlMsg($x = '')
	{
		$m	= 'http://joomlacode.org/gf/project/linkr2/frs/';
		$m	= '<a href="'. $m .'" target="_blank" style="color:#111;">download and install</a>';
	...
	function printInMsg($done = true)
	{
		...
		$api	= 'http://j.l33p.com/api/linkr/intro';
		$guide	= 'http://j.l33p.com/linkr/docs';
		$review	= 'http://extensions.joomla.org/extensions/core-enhancements/site-links/4010/review/';
		$faqs	= 'index.php?option=com_linkr&view=docs&about=faqs';
		$jc	= 'http://joomlacode.org/gf/project/linkr2/frs/';
		$lang	= 'http://j.l33p.com/linkr/translations';
		echo
		'<div class="inst-text">
			...
			<div class="inst-div">
				...
				<a href="'. $api .'" target="_blank">j.l33p.com/api/linkr</a>.
			</div>
			<h2 class="inst-title">What now?</h2>
			<div class="inst-div">
				By the time you install this extension, there might be patches 
				available that fix issues and bugs that have been reported already. 
				You should drop by <a href="'. $jc .'" target="_blank">JoomlaCode.org</a> 
				to do a quick check. Patches are easily recognizable because they have 
				the word &quot;patch&quot; in their file names.
			</div>
			...
			<div class="inst-div">
				...
				<a href="'. $lang .'" target="_blank">follow this link</a>.
			</div>
		</div>';
